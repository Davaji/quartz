...
<footer className={`${displayClass ?? ""}`}>
  <div className="footer-container">
    <div className="logo-div">
      <a href="https://www.t.me/davajinotes" className="logo-link" target="_blank" rel="noopener noreferrer">
        <svg className="logo-svg" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
